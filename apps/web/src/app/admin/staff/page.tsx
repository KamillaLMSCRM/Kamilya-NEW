         ...
         /commit если бэк вернул task_id. Polling внутри компонента. */}
              ...
              <Card>
                ...
                <CardContent className="text-sm text-foreground space-y-2">
                  <div>
                    Загрузите Excel <strong>.xlsx</strong> или CSV-файл. Для CSV подходят кодировки UTF-8 и
                    Windows-1251.
                  </div>
                  <div>
                  ...
                  <div className="text-muted-foreground text-xs">
                    Первая строка должна содержать заголовки. Можно писать по-русски или латиницей: Табельный номер /
                    personnel_number, Имя / first_name, Фамилия / last_name, Отдел / department, Должность / position.
                    Регистр не важен.
                  </div>
                </CardContent>
              </Card>
