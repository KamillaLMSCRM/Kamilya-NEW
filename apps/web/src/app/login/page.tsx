...
export default function LoginPage() {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-b from-primary/5 to-background">
      <SkipLink />
      <main id="main-content" className="w-full max-w-md p-8 bg-card rounded-xl shadow-card">
        ...
        {loading ? (
          ...
          <div className="space-y-6">
            ...
            <div className="text-center">
              <p className="text-sm text-muted-foreground mb-3">Ваш код для входа:</p>
        ...
        <div className="mt-6 text-center text-sm text-muted-foreground space-y-2">
          ...
          <div>
            <a href="/login/demo" className="inline-flex items-center gap-1.5 px-4 py-2 bg-muted text-foreground rounded-lg hover:bg-muted transition-colors text-sm font-medium">
              <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
