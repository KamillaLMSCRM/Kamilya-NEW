...
class Settings(BaseSettings):
    ...
    # Dedicated Qwen embedding replicas through the private KZ WireGuard hub.
    # Keep them separate from chat Qwen settings. VM126 reaches only the private
    # hub listeners; the ASUS model endpoints are not published through DNS.
    ASUS_EMBEDDINGS_ENABLED: bool = True
    ASUS_EMBEDDINGS_GX10_12_URL: str = "http://10.77.77.1:18003/v1"
    ASUS_EMBEDDINGS_GX10_12_MODEL: str = "Qwen/Qwen3-Embedding-8B"
    # Compatibility name retained for the established gx10-2 route.
    ASUS_EMBEDDINGS_URL: str = "http://10.77.77.1:18001/v1"
    ASUS_EMBEDDINGS_MODEL: str = "Qwen/Qwen3-Embedding-8B"
    ASUS_EMBEDDINGS_GX10_4_URL: str = "http://10.77.77.1:18004/v1"
    ASUS_EMBEDDINGS_GX10_4_MODEL: str = "Qwen3-Embedding-8B"
