...
@pytest.mark.parametrize(
    ...
    (
        ...
        "Основная идея коллекции — дорогая матовая эстетика и полноценные габариты, "
        "а не компактный вариант с маркетплейса.",
...
@pytest.mark.parametrize(
    ...
    (
        ...
        (
            "Основная идея коллекции — дорогая матовая эстетика и полноценные габариты, "
            "а не компактный вариант с маркетплейса. Главный акцент — металлическая "
            "торцевая ручка.",
            (
                "основная идея коллекции — дорогая матовая эстетика и полноценные габариты",
                "главный акцент — металлическая торцевая ручка",
            ),
        ),
        (
