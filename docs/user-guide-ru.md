...
> **Архивная версия.** Актуальный порядок входа, прохождения курсов, тестов и получения сертификата находится в [едином руководстве пользователя](USER_DOCUMENTATION_RU.md).
