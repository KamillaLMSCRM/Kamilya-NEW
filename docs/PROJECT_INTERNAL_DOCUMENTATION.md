...
должностей и сотрудников в навигации методолога. Ссылка **Открыть** у должности
ведёт на её каноническую карточку `/positions/{position_id}`. Группы обучения
ведутся в `/cohorts`, фактические назначения — в `/assignments`.
