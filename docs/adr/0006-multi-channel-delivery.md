...
> 2026-07-27 superseding note: the tenant-owned-channel principle still
> applies to paid tenant integrations, Telegram bots and WhatsApp. Platform
> transactional email is provided through Resend for login OTP, tenant
> registration/trial and system notifications. See
> `docs/product/tenant-registration-trial-flow.md`,
> `docs/architecture/2026-07-10_tenant-auth-email-telegram-resend.md` and
