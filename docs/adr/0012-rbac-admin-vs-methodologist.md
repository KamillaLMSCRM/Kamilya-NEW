...
| `/admin/enrollments`      | admin               | directly enroll a user — escape hatch                  |
...
| `POST /v1/courses/{id}/enrollments` (bulk by admin)       | `admin`, `org_admin`, `superadmin`         | same — admin-only by design                     |
...
# - POST /v1/courses/{id}/enrollments (bulk enroll — admin-only)
# - POST /v1/kiosks/*
# - GET /v1/admin/super/*
```
