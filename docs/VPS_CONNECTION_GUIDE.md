...
- Для маршрута не требуется публичный DNS или сертификат. Совместимая семья
  Voyage V4 является основной managed-линией embeddings; приватные Qwen-реплики
  и Cohere остаются резервами приложения.
