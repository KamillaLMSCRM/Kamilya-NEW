...
> **Мұрағаттық нұсқа.** Бұл файл ағымдағы өніммен толық салыстырылмаған. Өзекті орыс тіліндегі нұсқаулық: [Kamilya LMS пайдаланушы нұсқаулығы](USER_DOCUMENTATION_RU.md). Қазақша нұсқаны жарияламас бұрын қайта аудару қажет.
