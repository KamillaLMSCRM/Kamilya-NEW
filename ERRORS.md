...
- Симптом: первый disposable production-курс успешно создался, но два теста
  ...
  правильного ответа как не являющиеся дословной частью evidence.
...
- Исправление: retry каждый раз строится из неизменного урока без сырого
  ...
  выбранного evidence; дистрактор, совпадающий с evidence, отклоняется.
- Проверка: unit-suite `264 passed`; focused assessment/failover/release tests
