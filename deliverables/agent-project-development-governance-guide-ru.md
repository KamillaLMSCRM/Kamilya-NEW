...
Для GPT-6 Astra это особенно важно: модель уже умеет самостоятельно выбирать
нужные исходники и проверки, поэтому безусловное требование читать несколько
больших документов перед каждой правкой расходует контекст и повышает риск
конфликтующих инструкций. `AGENTS.md` должен маршрутизировать к источнику по типу
задачи, а не заставлять загружать весь набор.

### Что обычно полезно закрепить

- workspace и repository scope;
- запрещённые соседние проекты;
- маршруты к каноническим документам по типу задачи;
...
- обязательный список больших документов «перед каждой правкой»;
- полный suite после каждой локальной итерации, если достаточно focused feedback.
...
Официальная рекомендация OpenAI по GPT-6 Astra:

- Rethinking skills and prompts for GPT-6 Astra:
  https://developers.openai.com/blog/rethinking-skills-and-prompts-for-gpt-6-astra

Материалы Hermes Agent, использованные как дополнительный источник идей:
